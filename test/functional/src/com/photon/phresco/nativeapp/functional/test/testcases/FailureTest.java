...
public class FailureTest extends TestCase {
	...
	private static final String TAG = "*****FailureTest******";
	private GridView gridView;

	public FailureTest(Solo solo) {
	...
	public void testFailure() throws TestException {
		...
		try {
			...
			if (activityName.equalsIgnoreCase("HomeActivity")) {
				...
				Log.i(TAG,
						" Activity name ---->"
								+ soloLongPause.getCurrentActivity());
			...
			soloLongPause.clickLongOnView(gridView.getChildAt(3));
